...
public class ExtentReportAutomation {
	...
	public void before() {
		htmlreporter = new ExtentHtmlReporter(
				new File(System.getProperty("user.dir") + "./target/Extents Report.html"));
		...
		extent.setSystemInfo("Company Name ", "Supply House");
		extent.setSystemInfo("Project Name ", "QA Portal");
		extent.setSystemInfo("Application Name ", "e-Commerce Portal");
